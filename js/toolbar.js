...
var button_lst=["clear", "load", "save", "export", "upload", "selection", "canvas", "eraser", "outpaint", "accept", "cancel", "retry", "prev", "current", "next", "eraser_size_btn", "eraser_size", "resize_selection", "scale", "zoom_in", "zoom_out"];
...
var camera_transform_lst=["rotate_left", "rotate_right", "rotate_up", "rotate_down", "move_forward", "move_backward", "move_left", "move_right", "move_up", "move_down", "finish"];
var camera_all_lst=["update_3d", "rotate_left", "rotate_right", "rotate_up", "rotate_down", "move_forward", "move_backward", "move_left", "move_right", "move_up", "move_down", "finish"];
...
var toolbar=new w2toolbar({
    ...
    items: [
        ...
        { type: "new-line"},
        { type: "button", id: "update_3d", tooltip: "Update 3D", icon: "fa-solid fa-pen-to-square" },
        { type: "break" },
        { type: "button", id: "rotate_left", tooltip: "Rotate left", icon: "fa-solid fa-rotate-left", disabled: true },
        { type: "button", id: "rotate_right", tooltip: "Rotate right", icon: "fa-solid fa-rotate-right", disabled: true },
        { type: "button", id: "rotate_up", tooltip: "Rotate up", icon: "fa-solid fa-turn-up", disabled: true },
        { type: "button", id: "rotate_down", tooltip: "Rotate down", icon: "fa-solid fa-turn-down", disabled: true },
        { type: "break" },
        { type: "button", id: "move_forward", tooltip: "Move forward", icon: "fa-solid fa-circle-up", disabled: true },
        { type: "button", id: "move_backward", tooltip: "Move backward", icon: "fa-solid fa-circle-down", disabled: true },
        { type: "button", id: "move_left", tooltip: "Move left", icon: "fa-solid fa-arrow-left", disabled: true },
        { type: "button", id: "move_right", tooltip: "Move right", icon: "fa-solid fa-arrow-right", disabled: true },
        { type: "button", id: "move_up", tooltip: "Move up", icon: "fa-solid fa-arrow-up", disabled: true },
        { type: "button", id: "move_down", tooltip: "Move down", icon: "fa-solid fa-arrow-down", disabled: true },
        { type: "break" },
        { type: "button", id: "finish", tooltip: "Finish creation", icon: "fa-solid fa-circle-check", disabled: true },
    ],
    onClick(event) {
        switch(event.target){
            case "setting":
