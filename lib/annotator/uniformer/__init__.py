...
from lib.annotator.uniformer.mmseg.apis import init_segmentor, inference_segmentor, show_result_pyplot
from lib.annotator.uniformer.mmseg.core.evaluation import get_palette
from lib.annotator.util import annotator_ckpts_path
